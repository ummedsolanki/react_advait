    ...
    <>
      ...
      <div className="sap-section row-normal bg-green">
        <div className="sap-text">
          <h2>
            <strong>RISE with SAP in a Private Cloud-</strong>
            <br />
        ...
        <div className="sap-img-wrap">
          <img src="/src/assets/sapr1.jpg" alt="Future with SAP" className="sap-img" />
        </div>
      </div>
      ...
      <div className="sap-section row-reverse bg-white">
        <div className="sap-text">
          <h2>
            <strong>Transformation</strong> with Purpose
          </h2>
          <div className="sap-content">
            <p>
        ...
        <div className="sap-img-wrap">
          <img src="/src/assets/transformation.jpg" alt="Partner with Advait" className="sap-img" />
        </div>
      </div>
      ...
      <div className="unique-section">
        <div className="unique-header">
          <h2>
            What Makes
            <span className="highlight"> RISE with SAP -<br /> Private Cloud
            </span>
      ...
      <div className="sap-section row-reverse bg-white">
        <div className="sap-text">
          <h2>Why Partner <strong>with Advait</strong> for RISE with SAP - <strong>Private Cloud?</strong></h2>
          <div className="sap-content">
            <ul>
              <li>
      ...
      <div className="sap-section row-normal bg-green">
        <div className="sap-text">
          <h2>
            The <strong>Future is Intelligent.</strong>
            <br />
            The <strong>Platform is RISE.</strong>
            <br />
            The <strong>Partner is Advait.</strong>
          </h2>
          <div className="sap-content">
            <p>
        ...
        <div className="sap-img-wrap">
          <img src="/src/assets/digi.jpg" alt="Future with SAP" className="sap-img" />
        </div>
      </div>

      ...
      <div className="sap-background">
        <div className="sap-container">
          <section className="chemical-industry">
            <h2>
              <strong>Transforming the Chemical Industry</strong>: SAP Solutions Driving Efficiency
          ...
          <div className="sap-section row-normal bg-white">
            <div className="sap-text">
              <h2> <strong>Embracing</strong>  Digital Transformation in <strong>Chemicals</strong></h2>
            ...
            <div className="sap-img-wrap">
              <img src="/src/assets/tci1.png" alt="" className="sap-img" />
            </div>
          </div>
          <div className="sap-section row-reverse bg-green">
            <div className="sap-text">
              <h2> <strong>SAP: Catalyst for</strong> Innovation in Chemicals</h2>
              <div className="sap-content">
                <p>
            ...
            <div className="sap-img-wrap">
              <img src="/src/assets/tci2.png" alt="" className="sap-img" />
            </div>
          </div>

          <div className="sap-section row-normal bg-white">
            <div className="sap-text">
              <h2> <strong>Streamlining Operations for</strong> Maximum Efficiency</h2>
              <div className="sap-content">
                <p>
            ...
            <div className="sap-img-wrap">
              <img src="/src/assets/tci3.png" alt="" className="sap-img" />
            </div>
          </div>
          <div className="sap-section row-reverse bg-green">
            <div className="sap-text">
              <h2>Optimizing Supply<strong> Chain Performance</strong></h2>
              <div className="sap-content">
                <p>
            ...
            <div className="sap-img-wrap">
              <img src="/src/assets/tci4.png" alt="" className="sap-img" />
            </div>
          </div>

          <div className="sap-section row-normal bg-white">
            <div className="sap-text">
              <h2><strong>Driving Sustainability </strong>and Regulatory Compliance with Cloud Solutions</h2>
              <div className="sap-content">
                <p>
            ...
            <div className="sap-img-wrap">
              <img src="/src/assets/tci5.png" alt="" className="sap-img" />
            </div>
          </div>
          <div className="sap-section row-reverse bg-green">
            <div className="sap-text">
              <h2>Leveraging Cloud and <strong>Digital Platforms</strong></h2>
              <div className="sap-content">
                <p>
            ...
            <div className="sap-img-wrap">
              <img src="/src/assets/tci6.png" alt="" className="sap-img" />
            </div>
          </div>

          <div className="sap-section row-normal bg-white">
            <div className="sap-text">
              <h2>Overcoming<strong>Transformation Challenges</strong></h2>
              <div className="sap-content">
                <p>
            ...
            <div className="sap-img-wrap">
              <img src="/src/assets/tci7.png" alt="" className="sap-img" />
            </div>
          </div>
        </div>
      </div >
